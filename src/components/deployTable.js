...
const rows = [createData(null, "Floor 1"), createData(null, "Floor 2")];

export default function DeployTable(props) {
  let i = 1;
  ...
  return (
    <>
      <Table sx={{ minWidth: 700, border: 0 }} aria-label="customized table">
        <TableHead>
          <TableRow>
            <StyledTableCell>Deployment ID</StyledTableCell>
            <StyledTableCell align="center">Deployment Name</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (

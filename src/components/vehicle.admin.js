...
export default function Vehicle({ props }) {
  ...
  return (
    <div className="cus-subcont">
      ...
      {vis && <h2 className="add-cus-head">Add Vehicle</h2>}
      {modVis && <h2 className="add-cus-head">Modify Vehicle</h2>}
        ...
        {!vis && !modVis && (
          <>
            ...
            <article className="cus-box-content">
              ...
              <VehicleTable showModify={callbackfun} />
            </article>
          </>
        )}
        {vis && (

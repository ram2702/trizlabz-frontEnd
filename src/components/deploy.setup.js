...
export default function Deployment({ props }) {
  ...
  return (
    <div className="cus-subcont">
      ...
      {vis && <h2 className="add-cus-head">Add Deployment</h2>}
      {modVis && <h2 className="add-cus-head">Modify Deployment</h2>}
        ...
        {!vis && !modVis && (
          <>
            ...
            <article className="cus-box-content">
              ...
              <DeployTable showModify={callbackfun} />
            </article>
          </>
        )}
        {vis && (
